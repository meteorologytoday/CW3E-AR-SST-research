...
parser.add_argument('--save', action="save_true", help='Save the timeseries into an npz file')
...
for i, AR_var in enumerate(AR_vars):
    ...
    skills['pt-by-pt'][AR_var][:, data_good_idx] = np.nan
    skills['integrated'][AR_var][:, data_good_idx] = np.nan
